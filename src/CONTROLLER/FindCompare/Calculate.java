...
private MultilayerPerceptronCS mlp = null;
	...
	public float calculateNNSimilarity(String a, String b){
		...
		//
		//System.out.println(block+","+ChapmanLengthDeviation+","+CMSoundex+","+ChapmanMeanLength+","+ChapmanOrderedNameCompoundSimilarity+","+cosine+","+dice+","+EuclideanDistance+","+jaccard+","+Jaro+","+JaroWinkler+","+Levenshtein+","+MatchingCoefficient+","+MongeElkan+","+NeedlemanWunch+","+OverlapCoefficient+","+QGrams+","+SmithWaterman+","+SmithWatermanGotoh+","+SmithWatermanGotohWindowedAffine+","+TagLinkToken+","+Soundex+","+vectorSpace );
	...
	private float getNNSemantics(String in){
		in = in+",0";
		try{
		if((this.mlp==null)){this.mlp = (MultilayerPerceptronCS) weka.core.SerializationHelper.read("src/MODEL/NN0_9264_ALL.model");}
